    ...
    <div class="wrapper">
     ...
     <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold active"><a href="<?php echo base_url()?>user" class="waves-effect waves-cyan"><i class="mdi-social-people"></i> User</a></li>
...
?>  
              <div class="card-panel">
                <h4 class="header2">Tambah Admin</h4>
                <div class="row">
                  ...
                  <!-- Data User-->
              <div class="card-panel">
                <h4 class="header2">Data User/Admin</h4>
                  <table id="data-table-simple" class="responsive-table display" cellspacing="0">
                    ...
                    <tbody>
                      <?php $no=1; foreach($user as $admin):?>
                      <tr>
                        <td><?php echo $no++?></td>
                        <td><?php echo $admin->nama?></td>
                        <td><?php echo $admin->username?></td>
                        <td><?php echo $admin->password?></td>
                        <td><a onclick="return confirm('Yakin ingin menghapusnya?');" href="<?php echo base_url()?>User/hapus/<?php echo $admin->id?>" class="btn danger">Hapus</a></td>
                      </tr>
                    <?php endforeach;?>
                    </tbody>
                  </table>
